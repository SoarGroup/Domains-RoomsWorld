...
# #     rm -f $THISDIR/*.bat
# #   fi
#   FLAG="-XstartOnFirstThread"/Library/Java/JavaVirtualMachines/jdk1.8.0_60.jdk/Contents/Home/jre/lib>
# else
# #   if [ ! -e $SOAR_HOME/pkgIndex.tcl ]; then
...
java $FLAG  -Djava.library.path="$SOAR_HOME" -Djava.net.preferIPv4Stack=true -jar "$SOAR_HOME/SoarRobotServer.jar" $1 $2 $3 $4 $5 &
# java -jar "$SOAR_HOME/SoarRobotServer.jar" $1 $2 $3 $4 $5 &
popd > /dev/null
